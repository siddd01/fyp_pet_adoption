import { AlertCircle, ArrowLeft, ArrowRight, Lock, Mail, ShieldAlert } from "lucide-react";
...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(typeof err === 'string' ? err : "Unauthorized access.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-50 px-6">
      <div className="w-full max-w-md bg-white p-10 rounded-[3rem] shadow-[0_20px_70px_-20px_rgba(0,0,0,0.08)] border border-stone-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                type="email"
                placeholder="admin@sanoghar.com"
        ...
        <footer className="mt-10 text-center">
          <p className="text-stone-400 text-[9px] uppercase tracking-[0.25em] leading-relaxed">
            Authorized Personnel Only <br /> 
            <span className="text-stone-300">Encrypted Connection Active</span>
          </p>
        </footer>
      </div>
    </div>
