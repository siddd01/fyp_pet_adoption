                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          <div className="w-10 h-10  rounded-full flex items-center justify-center mr-3">
                            <span className="text-white text-lg"><img src={pets.find(p => p.id === app.pet_id)?.image_url || "/default-pet.png"} alt="Pet" className="w-full h-full object-cover rounded-full" /></span>
                          </div>
                          <div>
