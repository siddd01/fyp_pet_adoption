...
const AdminHandleAdoption = () => {
  ...
  const fetchApplications = async () => {
    ...
    try {
      ...
      // Now res.data.applications contains pet_name and pet_image from the JOIN
    ...
    <div className="min-h-screen bg-stone-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            <p className="text-xs font-semibold tracking-widest text-gray-400 uppercase mb-1.5">Admin Panel</p>
            <h1 className="text-4xl font-serif text-stone-900 leading-tight">Adoption Applications</h1>
            <p className="text-sm text-stone-500 mt-2">Review and manage all pet adoption requests</p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
            ...
            <div className="overflow-y-auto p-8 space-y-8">
              ...
              <div className="flex items-center gap-6 p-4 bg-stone-900 rounded-2xl text-white">
                <img src={selectedApp.pet_image} className="w-24 h-24 rounded-xl object-cover" alt="" />
                <div>
