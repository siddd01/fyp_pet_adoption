...
const StaffForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post("/staff/forgot-password", { email });
      navigate("/staff/reset-password", { state: { email } });
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-50 px-6">
      <div className="w-full max-w-md bg-white p-10 rounded-[3rem] shadow-[0_20px_70px_-20px_rgba(0,0,0,0.08)] border border-stone-100">
        ...
        >
          ...
          <span className="text-[10px] font-bold uppercase tracking-widest">Back to Staff Login</span>
        </button>
